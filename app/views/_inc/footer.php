    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
        ...
        <p>
          ...
          <a href="#">markus.tn73@gmail.com</a>
        </p>
      </div>
  ...
  <div class="container pt-3">
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 col-md-9 col-12">
        <ul class="site-footer-links">
          ...
          <li class="site-footer-link-item">
            <a href="#" class="site-footer-link">Contact Us Aa</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="row mt-2">
      ...
      <div class="col-lg-6 col-12 text-lg-end text-start">
        Distribution: <a rel="nofollow" href="https://themewagon.com" target="_blank">ThemeWagon</a>
      </div>
    </div>
  </div>
</footer>
